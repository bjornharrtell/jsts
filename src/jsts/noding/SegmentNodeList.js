...
/**
 * Was TreeMap in JTS, replaced with Object and sorting logic
 * @type {Object}
 * @private
 */
...
jsts.noding.SegmentNodeList.prototype.getEdge = function() { return this.edge; };
...
/**
   ...
   *
   * @param {Array} splitEdges the split edges for this edge (in order).
   * @private
   */
