...
jsts.geomgraph.DirectedEdge.prototype = new jsts.geomgraph.EdgeEnd();
 ...
 * another. E.g. if crossing from the INTERIOR to the EXTERIOR the depth
...
jsts.geomgraph.DirectedEdge.prototype.isLineEdge = function() {
  ...
  var isExteriorIfArea0 = !this.label.isArea(0) ||
      this.label.allPositionsEqual(0, jsts.geom.Location.EXTERIOR);
  var isExteriorIfArea1 = !this.label.isArea(1) ||
      this.label.allPositionsEqual(1, jsts.geom.Location.EXTERIOR);
...
jsts.geomgraph.DirectedEdge.prototype.isInteriorAreaEdge = function() {
  ...
  for (var i = 0; i < 2; i++) {
    if (!(this.label.isArea(i) &&
        this.label.getLocation(i, jsts.geomgraph.Position.LEFT) === jsts.geom.Location.INTERIOR && this.label
        .getLocation(i, jsts.geomgraph.Position.RIGHT) === jsts.geom.Location.INTERIOR)) {
...
jsts.geomgraph.DirectedEdge.prototype.setEdgeDepths = function(position, depth) {
  ...
  var oppositePos = jsts.geomgraph.Position.opposite(position);
