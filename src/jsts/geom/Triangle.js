 ...
 *
 */
jsts.geom.Triangle = OpenLayers.Class();
...
jsts.geom.Triangle.prototype.perpendicularBisector = function(a, b) {
  ...
  l1 = new jsts.algorithm.HCoordinate(a.x + dx / 2.0,
      a.y + dy / 2.0, 1.0);
  l2 = new jsts.algorithm.HCoordinate(a.x - dy + dx / 2.0,
      a.y + dx + dy / 2.0, 1.0);
 ...
 * which is the unique circle that is tangent to each of the triangle's
 * three sides.
 *
 * @param {jsts.geom.Coordinate}
 *        a a vertx of the triangle.
 ...
 * medians intersect (a triangle median is the segment from a vertex of the
 ...
 * Use {@link CGAlgorithms#orientationIndex(Coordinate,
 ...
 * of the triangle's angles meet.
 * It is the centre of the triangle's <i>incircle</i>,
 * which is the unique circle that is tangent to each of
