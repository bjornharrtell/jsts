...
export default class SimpleMinimumClearance {
  ...
  updateClearance () {
    if (arguments.length === 3) {
      let candidateValue = arguments[0]; let p0 = arguments[1]; let p1 = arguments[2]
      ...
      let candidateValue = arguments[0]; let p = arguments[1]; let seg0 = arguments[2]; let seg1 = arguments[3]
      if (candidateValue < this._minClearance) {
        this._minClearance = candidateValue
...
ComputeMCCoordinateSequenceFilter.constructor_ = function () {
  this.smc = null
  this._queryPt = null
  let smc = arguments[0]; let queryPt = arguments[1]
  this.smc = smc
