...
export default class NodedSegmentString {
  ...
  static getNodedSubstrings () {
    if (arguments.length === 1) {
      ...
      let segStrings = arguments[0]; let resultEdgelist = arguments[1]
  ...
  addIntersection () {
    if (arguments.length === 2) {
      let intPt = arguments[0]; let segmentIndex = arguments[1]
      this.addIntersectionNode(intPt, segmentIndex)
    } else if (arguments.length === 4) {
      let li = arguments[0]; let segmentIndex = arguments[1]; let geomIndex = arguments[2]; let intIndex = arguments[3]
