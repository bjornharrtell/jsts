...
export default class AffineTransformation {
  ...
  static reflectionInstance () {
    if (arguments.length === 2) {
      ...
      let x0 = arguments[0]; let y0 = arguments[1]; let x1 = arguments[2]; let y1 = arguments[3]
      var trans = new AffineTransformation()
  ...
  static rotationInstance () {
    if (arguments.length === 1) {
      ...
      let sinTheta = arguments[0]; let cosTheta = arguments[1]
      var trans = new AffineTransformation()
      trans.setToRotation(sinTheta, cosTheta)
      return trans
    } else if (arguments.length === 3) {
      let theta = arguments[0]; let x = arguments[1]; let y = arguments[2]
      return AffineTransformation.rotationInstance(Math.sin(theta), Math.cos(theta), x, y)
    } else if (arguments.length === 4) {
      let sinTheta = arguments[0]; let cosTheta = arguments[1]; let x = arguments[2]; let y = arguments[3]
      var trans = new AffineTransformation()
  ...
  static scaleInstance () {
    if (arguments.length === 2) {
      let xScale = arguments[0]; let yScale = arguments[1]
      var trans = new AffineTransformation()
      trans.setToScale(xScale, yScale)
      return trans
    } else if (arguments.length === 4) {
      let xScale = arguments[0]; let yScale = arguments[1]; let x = arguments[2]; let y = arguments[3]
      var trans = new AffineTransformation()
      trans.translate(-x, -y)
  ...
  setTransformation () {
    if (arguments.length === 1) {
      ...
      let m00 = arguments[0]; let m01 = arguments[1]; let m02 = arguments[2]; let m10 = arguments[3]; let m11 = arguments[4]; let m12 = arguments[5]
      this._m00 = m00
      this._m01 = m01
      this._m02 = m02
      this._m10 = m10
  ...
  transform () {
    if (arguments.length === 1) {
      ...
      if (arguments[0] instanceof Coordinate && arguments[1] instanceof Coordinate) {
        ...
        let seq = arguments[0]; let i = arguments[1]
