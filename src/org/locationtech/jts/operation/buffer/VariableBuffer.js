...
export default class VariableBuffer {
  ...
  static buffer () {
    if (arguments.length === 2) {
      ...
      const line = arguments[0]; const startDistance = arguments[1]; const endDistance = arguments[2]
      const distance = VariableBuffer.interpolate(line, startDistance, endDistance)
      const vb = new VariableBuffer(line, distance)
      return vb.getResult()
    } else if (arguments.length === 4) {
      const line = arguments[0]; const startDistance = arguments[1]; const midDistance = arguments[2]; const endDistance = arguments[3]
  ...
  static interpolate () {
    if (arguments.length === 3) {
      const line = arguments[0]; let startValue = arguments[1]; let endValue = arguments[2]
      ...
      const line = arguments[0]; let startValue = arguments[1]; let midValue = arguments[2]; let endValue = arguments[3]
      startValue = Math.abs(startValue)
