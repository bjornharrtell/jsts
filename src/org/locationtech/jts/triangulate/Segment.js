...
Segment.constructor_ = function () {
  ...
  if (arguments.length === 2) {
    ...
    let p0 = arguments[0]; let p1 = arguments[1]; let data = arguments[2]
    this._ls = new LineSegment(p0, p1)
    this._data = data
  } else if (arguments.length === 6) {
    let x1 = arguments[0]; let y1 = arguments[1]; let z1 = arguments[2]; let x2 = arguments[3]; let y2 = arguments[4]; let z2 = arguments[5]
    Segment.constructor_.call(this, new Coordinate(x1, y1, z1), new Coordinate(x2, y2, z2))
  } else if (arguments.length === 7) {
    let x1 = arguments[0]; let y1 = arguments[1]; let z1 = arguments[2]; let x2 = arguments[3]; let y2 = arguments[4]; let z2 = arguments[5]; let data = arguments[6]
