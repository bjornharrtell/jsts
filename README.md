...
The current version 0.13.1 is available for download as [tar.gz](https://github.com/downloads/bjornharrtell/jsts/jsts-0.13.1.tar.gz) or [zip](https://github.com/downloads/bjornharrtell/jsts/jsts-0.13.1.zip).
