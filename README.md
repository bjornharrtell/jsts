...
The current version 0.11.0 is available for download as [tar.gz](https://github.com/downloads/bjornharrtell/jsts/jsts-0.11.0.tar.gz) or [zip](https://github.com/downloads/bjornharrtell/jsts/jsts-0.11.0.zip).
